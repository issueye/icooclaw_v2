...
go build -ldflags "-s -w -X github.com/icooclaw/icooclaw/cmd/icooclaw/commands.version=%VERSION%" -o bin\%BINARY_NAME%.exe .\cmd\icooclaw
if errorlevel 1 exit /b 1
echo Build OK: bin\%BINARY_NAME%.exe
